...
(function () {
    var targets = document.querySelectorAll(
        ...
        '.whatis-card, .audience-card, .diff-item, .roadmap-item, ' +
        '.contact-form, .contact__intro'
    );
...
function handleContactSubmit(event) {
    ...
    var nombre = form.querySelector('#contact-name').value.trim();
    var correo = form.querySelector('#contact-email').value.trim();
    ...
    if (!nombre || !correo) {
        ...
        firstEmpty.focus();
        firstEmpty.style.borderColor = '#c0392b';
        setTimeout(function () { firstEmpty.style.borderColor = ''; }, 2000);
        return;
    }
...
(function () {
    ...
    const image = document.getElementById('apple-image');
